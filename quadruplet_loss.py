...
def embedImages(Images):
    ...
    flat = tf.layers.flatten(pool3, name='flatten')
...
# Calculate quadruplet loss for the give dists
loss = tf.reduce_mean(bh_quadruplet_loss(dists, Labels))
...
###
#Training the model for 50 000 epochs
###
